...
Using MySql database with two tables mailqueue_queue and mailqueue_send with PluginWfMysql. Then send email via scedule requests with PluginWfPhpmailer.  

Put mails in mailqueue table via create and call page send via scedule like a cron script.
